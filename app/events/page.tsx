...
export const metadata: Metadata = {
	...
	description:
		"Discover upcoming maritime events at OutJourney. Join OutJourney for industry speakers, networking opportunities, and maritime innovation discussions in Jakarta.",
	keywords: [
		"maritime events Jakarta",
		"OutJourney maritime events",
		"Jakarta maritime networking",
		"maritime speakers Jakarta",
		"Jakarta maritime conferences",
		"OutJourney maritime talks",
		"maritime industry events Jakarta",
		"Jakarta maritime meetings",
		"maritime professional development Jakarta",
		"Jakarta maritime community events",
		"OutJourney maritime calendar",
		"maritime student events Jakarta",
